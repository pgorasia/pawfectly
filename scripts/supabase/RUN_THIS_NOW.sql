-- ============================================================================
-- Clean up photos table schema
-- ============================================================================
-- Run this in Supabase SQL Editor
-- 
-- Changes:
-- 1. Add target_type column (determines what to look for: 'dog' or 'human')
-- 2. Remove unused columns: ai_text, ai_metadata, client_labels, server_labels
...
-- Set target_type based on bucket_type
...
-- Step 3: Remove classification column
ALTER TABLE photos DROP COLUMN IF EXISTS classification;

-- Step 4: Remove contains_both column (can be computed as contains_dog && contains_human)
