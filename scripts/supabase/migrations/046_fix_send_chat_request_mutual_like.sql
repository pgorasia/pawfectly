-- ============================================================================
-- Migration: Fix send_chat_request to create active conversation for mutual likes
-- If user already liked candidate and candidate sends like with compliment,
-- create conversation with status='active' instead of 'request'
-- ============================================================================
