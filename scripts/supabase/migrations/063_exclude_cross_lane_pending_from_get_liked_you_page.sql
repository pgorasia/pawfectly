-- ============================================================================
-- Migration: Exclude cross-lane pending connections from Liked You page
--
-- Cross-lane pending connections are now surfaced in Messages > Matches row.
-- The Liked You page should only show inbound likes that the viewer has not
-- hard-acted on, excluding any pending cross-lane pairs.
-- ============================================================================
